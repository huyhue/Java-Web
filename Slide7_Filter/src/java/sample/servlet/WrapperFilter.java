...
public class WrapperFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        ResponseWrapper wrapperResp = new ResponseWrapper(resp);
        if (debug) {
        ...
        try {
            ...
            PrintWriter out = wrapperResp.getWriter();
            out.println("<br/>The slide is licensed to HuyTP");
            out.close();
        } catch (Throwable t) {
	...
	public void addCookie (Cookie cookie) {
        ...
        public PrintWriter getWriter() throws IOException {
            return super.getWriter(); //To change body of generated methods, choose Tools | Templates.
        }
    }

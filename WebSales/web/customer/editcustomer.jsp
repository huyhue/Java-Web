    ...
    <body>
        <div class="container">
            ...
            <div class="form-center">
                <form  class="form-horizontal" action="Process?chucNang=Edit&id=<%= kh.getTaiKhoan()%> " method="post" id="editcustomerID">
                    <div class="form-group">
                                <label class="control-label col-sm-2">Name:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" value="<%= kh.getTen()%>" name="ten" placeholder="Enter name">
                                    <p id="error_date"></p>
                                </div>
                            </div>
                    <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" class="form-control"  value="<%= kh.getMatKhau()%>" name="matKhau" placeholder="Enter password">
                                    <p id="error_pass"></p>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="email"   value="<%= kh.getEmail()%>" id="email" placeholder="Enter email">
                                    <p id="error_email"></p>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="soDienThoai"  value="<%= kh.getSoDienThoai()%>" id="phone" placeholder="Enter phone number">
                                    <p id="error_phone"></p>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="diaChi" placeholder="Enter address"  value="<%= kh.getDiaChi()%>">
                                    <p id="error_date"></p>
                                </div>
                            </div>
                    <div class="form-group">        

                ...
                <form  class="form-horizontal" action="../Product?chucNang=Edit&masp=<%=sp.getProductID()%> " method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-sm-8">
                                    <input type="number" class="form-control " name="price" value="<%=sp.getPrice()%>"  name="tkkh" placeholder="Giá sản phẩm" id="cost">
                                </div>
                                <div class="col-sm-2">
                                    <p id="icon-cost"></p>
                                </div>
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for=""><span class=""></span>Hình ảnh sản phẩm:</label>
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-sm-8">

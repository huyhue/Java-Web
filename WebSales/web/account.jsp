...
<html>
    ...
    <body> 
        <%
            Map<String, String> showLanguage = new NgonNguDAO().vietnameseLanguage();
            ...
            if (lang != null) {
                if (lang.equals("Vietnamese")) {
                    ...
                    showLanguage = new NgonNguDAO().japaneseLanguage();
                } else if (lang.equals("China")) {
                    showLanguage = new NgonNguDAO().chinaLanguage();
                }
            }
        %>
        <!--header-->
            ...
            <jsp:include page="header/header-bottom.jsp"></jsp:include>
                ...
                <div class="content">
                    <div class="account-in">
                        <h2><%= showLanguage.get("Login.TieuDe")%></h2>
                    <div class="col-md-7 account-top">
                        <form action="Login?action=Login" method="post">
                            <div> 	
                                <span><%= showLanguage.get("Login.TenDangNhap")%>*</span>
                                <input type="text" name="username"> 
                            </div>
                            <div> 
                                <span class="pass"><%= showLanguage.get("Login.MatKhau")%>*</span>
                            ...
                            <%}%>
                            <input type="submit" value="<%= showLanguage.get("Login.Submit")%>"> <br/>
                    ...
                    <div class="col-md-5 left-account ">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                ...
                                <li><a href="DaNgonNgu?lang=Japan">Japanese</a></li>
                                <li role="separator" class="divider"></li>
                                <li><a href="DaNgonNgu?lang=China">China</a></li>
                            </ul>
                        </div>
